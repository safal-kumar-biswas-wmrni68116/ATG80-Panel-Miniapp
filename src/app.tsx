...
import '@/i18n';
// TypeScript may not have declarations for .less side-effect imports in this project setup.
// Suppress the module-not-found error for the side-effect stylesheet import.
// @ts-ignore
import './app.less';
